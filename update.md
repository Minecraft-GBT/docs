...
- 发布预告 ([MTRBBS](//www.mtrbbs.top/thread-7409-1-1.html))
...
- 通过了猫跃城建服务器的道路交通标志包使用 & 整合申请 (经 QQ)
- 通过了 Meeeeeooooow City 服务器的道路交通标志包使用 & 整合 & 二创申请 (经 MTRBBS)
- 添加了 Discord 申请方式

### 2024.10.24

- 通过了峡东工艺服务器的道路交通标志包使用申请 (经 QQ)
