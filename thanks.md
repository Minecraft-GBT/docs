...
const members = [
  ...
  },
  {
    ...
    name: 'Jonathan Ho',
    title: 'Minecraft Transit Railway 作者',
    links: [
  ...
  },
  {
    ...
    name: 'Zbx1425',
    title: 'Nemo\'s Transit Expansion 作者',
    links: [
      ...
      { icon: { svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>' }, link: 'mailto:support@zbx1425.cn' },
...
> [!NOTE]
> 特别感谢以下人员，他们为 GBT 系列包的诞生和完善做出了不可磨灭的贡献。
...
注：使用默认头像的即为 GTEH 无法寻找到合适的头像以放置。以上排序不分先后。

头像如有侵权，我很抱歉，请联系删除。头像可能是其所有者的商标。本站 / 本项目与除 xingteh 外的所有项目 / 人员 / 企业 / 单位 / 团队无隶属关系。部分图标来自 Font Awesome。使用的图像可能为了适应页面有略微调整。